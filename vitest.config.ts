  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "src/app/api/users/recover/route.ts",
        "src/app/api/users/[userId]/recovery/route.ts",
        "src/app/api/users/session/route.ts",
        "src/app/api/users/devices/route.ts",
        "src/app/api/users/devices/[deviceId]/route.ts",
        "src/app/api/sessions/[sessionId]/votes/[participantId]/route.ts",
        "src/app/api/sessions/[sessionId]/votes/consensus/route.ts",
      ],
      exclude: [
        "src/lib/prisma.ts",
        "src/lib/upload.ts",
